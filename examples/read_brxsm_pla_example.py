#!/usr/bin/env python3
"""
Example: Reading plasma small molecules (brxsm_pla)

Demonstrates reading plasma quantification data and comparing with reference ranges.

Usage:
    python read_brxsm_pla_example.py [xml_file]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Read plasma small molecule quantification data"
    )
    parser.add_argument('xml_file', nargs='?', help='Path to plasma XML file')
    ...
    if args.xml_file:
        ...
        xml_file = DATA_DIR / "plasma_quant_report.xml"
    ...
    print("=" * 60)
    print("Plasma Small Molecules (brxsm_pla)")
    print("=" * 60)
