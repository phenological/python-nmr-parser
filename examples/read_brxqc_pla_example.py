#!/usr/bin/env python3
"""
Example: Reading plasma quality control data (brxqc_pla)

Demonstrates reading plasma QC report and checking test results.

Usage:
    python read_brxqc_pla_example.py [xml_file]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Read plasma quality control data"
    )
    parser.add_argument('xml_file', nargs='?', help='Path to plasma QC XML file')
    ...
    if args.xml_file:
        ...
        xml_file = DATA_DIR / "plasma_qc_report.xml"
    ...
    print("=" * 60)
    print("Plasma Quality Control (brxqc_pla)")
    print("=" * 60)
